# Instructions for training Llama3.1-8B-MaxText on TPU trillium (v6e-32)
...
```
completed step: 14, seconds: 3.495, TFLOP/s/device: 407.225, Tokens/s/device: 7031.689, total_weights: 786432, loss: 5.864
```
